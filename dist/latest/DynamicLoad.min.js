var DynamicLoad;
(function(f){var h=function(){function a(d,c){this.cloneNodes=[];if(d instanceof HTMLElement){var a=document.createElement("div");a.appendChild(d.cloneNode(!0));this.element=d;this.elemHTML=a.innerHTML;d.style.display="none";c&&(c.innerHTML="");this.parent=c||d.parentNode}else this.elemHTML=d,c&&(c.innerHTML=""),this.parent=c}a.prototype.bind=function(d){for(var a=1;a<this.cloneNodes.length;a++)this.parent.removeChild(this.cloneNodes[a].node);if(0!=this.cloneNodes.length){this.cloneNodes=[this.cloneNodes[0]];
for(var a=Object.keys(d),b=0;b<a.length;b++)if(this.cloneNodes[0].cloneData[a[b]]!=d[a[b]]){a=this.bindedNodes(d);for(b=a.length-1;0<=b;b--)this.parent.insertBefore(a[b],this.cloneNodes[0].nodes[this.cloneNodes[0].nodes.length-1].nextSibling);for(b=0;b<this.cloneNodes[0].nodes.length;b++)this.parent.removeChild(this.cloneNodes[0].nodes[b]);this.cloneNodes[0].nodes=a;this.cloneNodes[0].cloneData=JSON.parse(JSON.stringify(d));break}}else{a=this.bindedNodes(d);for(b=a.length-1;0<=b;b--)this.parent.insertBefore(a[b],
this.element?this.element.nextSibling:this.parent.firstChild);this.cloneNodes.push({data:d,cloneData:JSON.parse(JSON.stringify(d)),nodes:a})}return this};a.prototype.refresh=function(){for(var d=0;d<this.cloneNodes.length;d++)for(var a=Object.keys(this.cloneNodes[d].data),b=0;b<a.length;b++)if(this.cloneNodes[d].cloneData[a[b]]!=this.cloneNodes[d].data[a[b]]){a=this.bindedNodes(this.cloneNodes[d].data);for(b=a.length-1;0<=b;b--)this.parent.insertBefore(a[b],this.cloneNodes[d].nodes[this.cloneNodes[d].nodes.length-
1].nextSibling);for(b=0;b<this.cloneNodes[d].nodes.length;b++)this.parent.removeChild(this.cloneNodes[d].nodes[b]);this.cloneNodes[d].nodes=a;this.cloneNodes[d].cloneData=JSON.parse(JSON.stringify(this.cloneNodes[d].data));break}return this};a.prototype.repeat=function(d,a){for(var b=0;b<this.cloneNodes.length;b++)if(-1==d.indexOf(this.cloneNodes[b].data)){for(var e=0;e<this.cloneNodes[b].nodes.length;e++)this.parent.removeChild(this.cloneNodes[b].nodes[e]);this.cloneNodes.splice(b,1);--b}a&&this.refresh();
for(var g=this.cloneNodes.length-1,b=d.length-1;0<=b;b--)if(-1!=g&&this.cloneNodes[g].data===d[b])g--;else{for(var f=this.bindedNodes(d[b]),k=-1==g?this.element?this.element.nextSibling:this.parent.firstChild:this.cloneNodes[g].nodes[this.cloneNodes[g].nodes.length-1].nextSibling,e=f.length-1;0<=e;e--)this.parent.insertBefore(f[e],k);this.cloneNodes.splice(g+1,0,{data:d[b],cloneData:JSON.parse(JSON.stringify(d[b])),nodes:f})}return this};a.prototype.bindedNodes=function(d){var a=document.createElement("div");
a.innerHTML=this.elemHTML;if(d)for(var b=Object.keys(d),e=0;e<b.length;e++)a.innerHTML=a.innerHTML.replace(new RegExp("{{"+b[e]+"}}","g"),d[b[e]]);d=[];d.length=a.childNodes.length;for(e=0;e<a.childNodes.length;e++)d[e]=a.childNodes[e];return d};return a}();f.Element=h})(DynamicLoad||(DynamicLoad={}));
(function(f){var h=function(){function a(d,a,b){this.callback=[];this.method=d;this.url=a;this.setData(b)}a.prototype.addCallback=function(a){this.callback.push(a);return this};a.prototype.send=function(a){var c=this,b=this.callback,e=new XMLHttpRequest,g=function(e,g){e&&(c.status=e);g&&(c.responseText=g);var f;f="json"==a?JSON.parse(c.responseText):c.responseText;for(var r=0;r<b.length;r++)b[r](e,f)};if(this.status)g();else{var f=this.url+(-1==this.url.indexOf("?")?"?":"&")+"_="+(new Date).getTime();
...
this.contentType="application/json");return this};a.prototype.asString=function(a){a&&this.addCallback(a);this.send("string")};a.prototype.asJson=function(a){a&&this.addCallback(a);this.send("json")};a.get=function(d){return new a("GET",d)};a.put=function(d,c){return(new a("PUT",d)).setData(c)};a.post=function(d,c){return(new a("POST",d)).setData(c)};a["delete"]=function(d,c){return(new a("DELETE",d)).setData(c)};return a}();f.Http=h})(DynamicLoad||(DynamicLoad={}));
(function(f){var h=function(){function a(a,c,b){this.type="text/css";this.rel="stylesheet";this.callback=[];this.href=a;c&&(this.type=c);b&&(this.rel=b)}a.prototype.addCallback=function(a){this.callback.push(a);return this};a.prototype.load=function(){var d=this;this.css=a.loaded[this.href];var c=function(){for(var a=0;a<d.callback.length;a++)d.callback[a]()};this.css&&0<this.css.count?(this.css.count+=1,c()):(a.loaded[this.href]={link:document.createElement("link"),count:1},this.css=a.loaded[this.href],
this.css.link.type=this.type,this.css.link.rel=this.rel,this.css.link.href=this.href,this.css.link.onload=c,a.head.appendChild(this.css.link));return this};a.prototype.destroy=function(){this.css||(this.css=a.loaded[this.href]);--this.css.count;return 0==this.css.count?(a.head.removeChild(this.css.link),this.css=a.loaded[this.href]=null,!0):!1};a.getInstance=function(d,c,b){return new a(d,c,b)};a.head=document.getElementsByTagName("head")[0];a.loaded={};return a}();f.LoadCss=h})(DynamicLoad||(DynamicLoad=
{}));
(function(f){var h=function(){function a(a){var c=this;this.isAppend=!1;this.callback=[];this.src=a;this.http=f.Http.get(a).addCallback(function(a,d){var g=document.createElement("div");g.innerHTML=d;if(c.dataBindRule)for(var f=Object.keys(c.dataBindRule),k=0;k<f.length;k++)g.innerHTML=g.innerHTML.replace(new RegExp("{{"+f[k]+"}}","g"),c.dataBindRule[f[k]]);c.isAppend||(c.element.innerHTML="");(function(a){for(var d=g.childNodes,b=0;b<d.length;b++)a.appendChild(d[b])})(c.element);componentHandler&&componentHandler.upgradeAllRegistered();
...
1,c<a.length&&b<c?c:a.length)};return a}();f.Location=h})(DynamicLoad||(DynamicLoad={}));
(function(f){var h=function(){function a(){}a.uriListener=function(a){f.Location.enchantUrl()&&a();window.addEventListener("hashchange",function(){f.Location.enchantUrl()&&a()})};a.run=function(d){var c=function(b,d,h){var k=function(a){var b={},e=a[d];if(!e)for(var f=Object.keys(a),k=0;k<f.length;k++){var p=new RegExp("^"+f[k].replace(/\{\*}$/,"(.+)").replace(/\{([^\/]+)}/g,"([^\\/]+)")+"$");if(p.test(d)){for(var e=p.exec(f[k]).slice(1),p=p.exec(d).slice(1),l=0;l<e.length;l++)b[e[l].replace(/^\{(.+)}$/,
"$1")]=p[l];e=a[f[k]];break}}"string"==typeof e?c(e,d,h):h(e,b)};a.routes[b]?k(a.routes[b]):f.Http.get(b).addCallback(function(d,c){a.routes[b]=c;k(c)}).asJson()},b=function(a,b,d,c){if(a){a=a.split(".");for(var f=0;f<a.length;f++)if(b[a[f]])b=b[a[f]];else return;"function"==typeof b&&b(c,d)}};a.uriListener(function(){for(var e=f.Location.path(),g=0;g<a.curJs.length;g++)a.curJs[g].options.reload&&(b(a.curJs[g].options.destroy,window,a.curJs[g].options.data,a.curParams),a.curJs[g].loadJs.destroy(),
a.curJs.splice(g,1),g--);var h=[],k=[],v=function(){a.curHtml&&(a.curHtml.destroy(),a.curHtml=null)},q=function(d){for(var c=0;c<a.curJs.length;c++)b(a.curJs[c].options.destroy,window,a.curJs[c].options.data,d),a.curJs[c].loadJs.destroy();a.curJs=h};c(d,e,function(c,d){var e={},g;for(g in a.curParams)a.curParams.hasOwnProperty(g)&&(e[g]=a.curParams[g]);a.curParams=d;if(c){var l=function(b){if(c.html){var d=document.getElementById("body");d||(d=document.getElementsByTagName("body")[0]);a.curHtml=f.LoadHtml.getInstance(c.html);
