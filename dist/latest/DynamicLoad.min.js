...
f.open(this.method,d,!0);f.setRequestHeader("Content-Type","application/json");f.onload=function(){g(f.status,f.responseText)};this.data?f.send(this.data):f.send()}};a.prototype.setData=function(a){this.data=a;"string"!=typeof this.data&&(this.data=JSON.stringify(this.data));return this};a.prototype.asString=function(a){this.addCallback(a);this.send("string")};a.prototype.asJson=function(a){this.addCallback(a);this.send("json")};a.get=function(e){return new a("GET",e)};a.put=function(e,b){return(new a("PUT",
