...
f.open(this.method,d,!0);this.contentType&&f.setRequestHeader("Content-Type",this.contentType);this.auth&&f.setRequestHeader("Authorization",this.auth);f.onload=function(){g(f.status,f.responseText)};this.data?f.send(this.data):f.send()}};a.prototype.setAuth=function(a){this.auth=a;return this};a.prototype.setData=function(a){this.data=a;this.data instanceof FormData?this.contentType=void 0:"string"!=typeof this.data&&(this.data=JSON.stringify(this.data),this.contentType="application/json");return this};
a.prototype.asString=function(a){a&&this.addCallback(a);this.send("string")};a.prototype.asJson=function(a){a&&this.addCallback(a);this.send("json")};a.get=function(e){return new a("GET",e)};a.put=function(e,b){return(new a("PUT",e)).setData(b)};a.post=function(e,b){return(new a("POST",e)).setData(b)};a["delete"]=function(e,b){return(new a("DELETE",e)).setData(b)};return a}();d.Http=h})(DynamicLoad||(DynamicLoad={}));
