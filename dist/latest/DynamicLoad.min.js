...
a.innerHTML=this.elemHTML;if(d)for(var b=Object.keys(d),e=0;e<b.length;e++)a.innerHTML=a.innerHTML.replace(new RegExp("{{"+b[e]+"}}","g"),d[b[e]]);d=[];d.length=a.childNodes.length;for(e=0;e<a.childNodes.length;e++)d[e]=a.childNodes[e];console.log(d);return d};return a}();f.Element=h})(DynamicLoad||(DynamicLoad={}));
