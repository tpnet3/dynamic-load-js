...
this.handlers[a].handler,!1);this.handlers=[];return this};a.onVisibilityChange=function(c,b){var d;return function(){var e=a.isElementInViewport(c);e!=d&&(d=e,"function"==typeof b&&b(e))}};a.isElementInViewport=function(a){a=a.getBoundingClientRect();return 0<=a.top&&0<=a.left};return a}();f.Listener=h})(DynamicLoad||(DynamicLoad={}));
