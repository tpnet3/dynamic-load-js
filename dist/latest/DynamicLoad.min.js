...
for(var g=this.cloneNodes.length-1,b=d.length-1;0<=b;b--)if(-1!=g&&this.cloneNodes[g].data===d[b])g--;else{for(var f=this.bindedNodes(d[b]),k=-1==g?this.element?this.element.nextSibling:this.parent.firstChild:this.cloneNodes[g].nodes[this.cloneNodes[g].nodes.length-1].nextSibling,e=0;e<f.length;e++)this.parent.insertBefore(f[e],k);this.cloneNodes.splice(g+1,0,{data:d[b],cloneData:JSON.parse(JSON.stringify(d[b])),nodes:f})}return this};a.prototype.bindedNodes=function(d){var a=document.createElement("div");
