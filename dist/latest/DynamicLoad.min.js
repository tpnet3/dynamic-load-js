var DynamicLoad;
(function(d){var h=function(){function a(a,b){this.callback=[];this.method=a;this.url=b}a.prototype.addCallback=function(a){this.callback.push(a);return this};a.prototype.send=function(a){var b=this,c=this.callback,f=new XMLHttpRequest,g=function(f,g){f&&(b.status=f);g&&(b.responseText=g);var d;d="json"==a?JSON.parse(b.responseText):b.responseText;for(var q=0;q<c.length;q++)c[q](f,d)};if(this.status)g();else{var d=this.url+(-1==this.url.indexOf("?")?"?":"&")+"_="+(new Date).getTime();f.open(this.method,
d,!0);f.setRequestHeader("Content-Type","application/json");f.onload=function(){g(f.status,f.responseText)};this.data?f.send(this.data):f.send()}};a.prototype.setData=function(a){this.data=a;"string"!=typeof this.data&&(this.data=JSON.stringify(this.data));return this};a.prototype.asString=function(){this.send("string")};a.prototype.asJson=function(){this.send("json")};a.get=function(e){return new a("GET",e)};a.put=function(e,b){return(new a("PUT",e)).setData(b)};a.post=function(e,b){return(new a("POST",
e)).setData(b)};a["delete"]=function(e,b){return(new a("DELETE",e)).setData(b)};return a}();d.Http=h})(DynamicLoad||(DynamicLoad={}));
