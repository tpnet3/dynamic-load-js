...
(function(f){var h=function(){function a(a){this.handlers=[];this.element=a}a.prototype.inViewport=function(c,b){var d=a.onVisibilityChange(c,b);this.handlers.push({events:["DOMContentLoaded","load","scroll","resize"],handler:d});addEventListener?(this.element.addEventListener("DOMContentLoaded",d,!1),this.element.addEventListener("load",d,!1),this.element.addEventListener("scroll",d,!1),this.element.addEventListener("resize",d,!1)):this.element.attachEvent&&(this.element.attachEvent("onDOMContentLoaded",
d),this.element.attachEvent("onload",d),this.element.attachEvent("onscroll",d),this.element.attachEvent("onresize",d));setTimeout(d,0);return this};a.prototype.destroy=function(){for(var a=0;a<this.handlers.length;a++)if(this.element.removeEventListener)for(var b=0;b<this.handlers[a].events.length;b++)this.element.removeEventListener(this.handlers[a].events[b],this.handlers[a].handler,!1);else if(this.element.detachEvent)for(b=0;b<this.handlers[a].events.length;b++)this.element.detachEvent("on"+this.handlers[a].events[b],
this.handlers[a].handler,!1);this.handlers=[];return this};a.onVisibilityChange=function(c,b){var d;return function(){var e=a.isElementInViewport(c);e!=d&&(d=e,"function"==typeof b&&b(e))}};a.isElementInViewport=function(a){a=a.getBoundingClientRect();return a.top<=(window.innerHeight||document.documentElement.clientHeight)&&a.left<=(window.innerWidth||document.documentElement.clientWidth)};return a}();f.Listener=h})(DynamicLoad||(DynamicLoad={}));
